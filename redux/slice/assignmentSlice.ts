...
export const fetchAssignments = createAsyncThunk(
  ...
  async (_, thunkApi) => {
    try {
      const response = await axiosClient.get("/mobile/assignments/assignments");
  ...
  async (id: string, thunkApi) => {
    try {
      const response = await axiosClient.get(
        `/mobile/assignments/get-assignment-viewById/${id}`
      );
      return response.data;
    } catch (error: unknown) {
      if (error instanceof AxiosError) {
  ...
  async (data: FormData, thunkApi) => {
    try {
      const response = await axiosClient.post(
        "/mobile/assignments/create-assignment",
        data,
        {
          headers: {
...
export const GenerateAssignmentById = createAsyncThunk(
  ...
  async (id: string, thunkApi) => {
    try {
      const response = await axiosClient.post(
        `/mobile/assignments/generate-question/${id}`
      );
      return response.data;
    } catch (error) {
      if (error instanceof AxiosError) {
  ...
  async (id: string, thunkApi) => {
    try {
      const response = await axiosClient.delete(
        `/mobile/assignments/delete-assignment/${id}`
      );
      return response.data;
    } catch (error) {
      if (error instanceof AxiosError) {
