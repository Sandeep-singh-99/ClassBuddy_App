  ...
  async ({ id, data }: { id: string; data: Record<string, any> }, thunkApi) => {
    try {
      const response = await axiosClient.post(
        `/mobile/ai-evaluator/${id}/evaluate`,
        data
      );
...
export const fetchSubmissionResult = createAsyncThunk(
  ...
  async (id: string, thunkApi) => {
    try {
      const response = await axiosClient.get(`/mobile/submissions/student-view/${id}`);
      return response.data;
    } catch (error) {
      if (error instanceof AxiosError) {
        return thunkApi.rejectWithValue(
  ...
  async (id: string, thunkApi) => {
    try {
      const response = await axiosClient.get(
        `/mobile/submissions/assignment-stats/${id}`
      );
      return response.data;
    } catch (error) {
      if (error instanceof AxiosError) {
...
export const fetchAllStudentSubmissions = createAsyncThunk(
  ...
  async (id: string, thunkApi) => {
    try {
      const response = await axiosClient.get(
        `/mobile/submissions/assignment-marks/${id}`
      );
      return response.data;
    } catch (error) {
      if (error instanceof AxiosError) {
...
export const totalSubmission = createAsyncThunk(
  ...
  async (_, thunkApi) => {
    try {
      const response = await axiosClient.get("/mobile/submissions/total-submissions");
      return response.data;
    } catch (error) {
      if (error instanceof AxiosError) {
        return thunkApi.rejectWithValue(
...
export const studentSubmissionStats = createAsyncThunk(
  ...
  async (_, thunkApi) => {
    try {
      const response = await axiosClient.get(
        "/mobile/submissions/student-submissions-stats"
      );
      return response.data;
    } catch (error: unknown) {
      if (error instanceof AxiosError) {
...
export const fetchStudentAssignmentStats = createAsyncThunk(
  ...
  async (_, thunkApi) => {
    try {
      const response = await axiosClient.get(
        "/mobile/submissions/student/assignments"
      );
      return response.data;
    } catch (error) {
      if (error instanceof AxiosError) {
...
export const fetchStudentPerformanceStats = createAsyncThunk("submission/fetchStudentPerformanceStats", async (_, thunkApi) => {
  try {
    const response = await axiosClient.get("/mobile/submissions/student-performance-stats");
    return response.data;
  } catch (error) {
    if (error instanceof AxiosError) {
        return thunkApi.rejectWithValue(
